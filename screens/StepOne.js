  ...
  return (
    <View style={styles.container}>
        <StatusBar translucent backgroundColor="transparent" barStyle="dark-content" />
            ...
            <TouchableOpacity style={styles.loginBtn} onPress={()=>Skip()}>
            ...
            <Image
                      ...
                      source={require('../src/images/image_stepOne.png')}
                    />
            <Image
        ...
        <View style={styles.contentStep}>
            <Text style={{fontSize : 40, color : "#fff"}}>Paso 1.</Text>
        ...
        <View style = {styles.barBottom}>
                <View>
                    <Text>
                        ...
                        <TouchableOpacity  onPress={()=>goToScreen("StepThree") }>
                            <Image
                            style={styles.btn_step}
                            source={require('../src/images/step_disabled.png')}
                            />
